...
public class GambitionInputDialog extends Dialog {

    public GambitionInputDialog(Context context) {
    ...
    public static class Builder {
        ...
        public GambitionInputDialog create() {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            // instantiate the dialog with the custom Theme  
            final GambitionInputDialog dialog = new GambitionInputDialog(context);
